...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Kennedy Mbithi
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className='home_description'>I'm a creative software developer based in Nairobi, and I'm very passionate and dedicated to my work.</p>
